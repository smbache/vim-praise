if exists('g:praise_templates')
  let s:templates = g:praise_templates
else
  let s:templates = get(g:, 'praise_more_templates', []) + [
...
if exists('g:praise_types')
  let s:types = g:praise_types
else
  let s:types = get(g:, 'praise_more_types', []) + [
...
if exists('g:praise_adjectives')
  let s:adjectives = g:praise_adjectives
else
  let s:adjectives = get(g:, 'praise_more_adjectives', []) + [
...
if exists('g:praise_adverbs')
  let s:adverbs = g:praise_adverbs
else
  let s:adverbs = get(g:, 'praise_more_adverbs', []) + [
...
if exists('g:praise_exclams')
  let s:exclams = g:praise_exclams
else
  let s:exclams = get(g:, 'praise_more_exclams', []) + [
        \ 'Easy as, bro',
        \ 'Sweet as, bro',
        \ 'YEES',
        \ 'WOOT',
